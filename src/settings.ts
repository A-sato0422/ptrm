...
const tasksData: Task[] = [
    { id: 1, category: 'blue', name: 'ペルビックティルト', youtubeUrl: 'https://www.youtube.com/watch?v=example1', reason: '骨盤の分節的な動きと、ニュートラルポジションの認識を促すため。' },
    { id: 2, category: 'blue', name: '3D呼吸', youtubeUrl: '', reason: '肋骨の広がりを意識し、深い呼吸を通じてコアの安定化を図るため。' },
    { id: 3, category: 'blue', name: 'チェストリフト', youtubeUrl: '', reason: '腹部の安定性を保ちながら、胸椎の屈曲可動域を確保するため。' },
    { id: 4, category: 'blue', name: 'シングルレッグストレッチ', youtubeUrl: 'https://www.youtube.com/watch?v=leg_stretch', reason: '骨盤の安定性を維持しながら股関節を動かす能力を養うため。' },
    { id: 5, category: 'red', name: 'スクワット', youtubeUrl: '', reason: '下半身の基礎筋力を構築し、日常動作の質を向上させるため。' },
    { id: 6, category: 'red', name: 'デッドリフト', youtubeUrl: '', reason: '後面連鎖の強化と正しいヒンジ動作の習得のため。' },
    { id: 7, category: 'green', name: 'ラダートレーニング', youtubeUrl: '', reason: '俊敏性と協調性を向上させ、スポーツパフォーマンスを高めるため。' },
    { id: 8, category: 'yellow', name: 'バランスボードトレーニング', youtubeUrl: '', reason: '体幹の安定性と固有受容感覚を向上させるため。' }
];

// サンプルトレーナーデータ
const trainersData: Trainer[] = [
    { id: 1, name: '田中 美咲', email: 'm.tanaka@gympro.jp', avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA2gTAkNMGayh0iynd3OWRaCdhILQkmby4SAH3bPE8hRjqPflU0bR8nxFVmir1TzGWzFUE1FZ6sOX_izYs-EwbRPpL_f63ttrM0He29yqiZ1paaq9ESwxyVvytRl0z2JI5mFsGWAtE7WPYqbMN8HDmv2a0L7FWOJ47TSGQ2Xy75qfiXQLApROvZXxCBcW_J69NezHEi12vrfI93mkVmYY5aEFqWnz6M1vvccDjAI22gkbg8pwk68rj7oXs2agflbd_UstlIQWtkNxk', role: 'Head', isOnline: true },
    { id: 2, name: '佐藤 健太', email: 'k.sato@gympro.jp', avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAoBZf-C9avRaokbjftgmHxHPKrS7ZBSbJpeNLPBfZon1mDSmIgzj8qVCPrGY-9Rwx1LFgITBVnJVQ9_p56j3IXkN_Ud2gD2Vj_5r01PyrThZtlqQZeg1_-wWNEljSYTYGh66CC9QJ4Z6IXFMsFqZvhBjswa3FnWF5Atob7O_Mupq2lmEOb20-2y6uwYbwS9mCXlOPLbirM3eHLyOH0-fMXOrfq9hg847gjaZHRm_7V4cfVg5pk5lJ3VdcGQ4qz1zcfaeN0ux3jEHk', role: 'Staff', isOnline: false },
    { id: 3, name: '高橋 愛理', email: 'a.takahashi@gympro.jp', avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBZ2q0OJ2u0fG8VfrrC8bRxqq6vcABvxtoO4ogAfDpIZ0O2hsx-8EUutJzXzCK9YhSO4dMz3TJQq59jyPAXbxyhU0CmIOR7BU0FVblJK9GhIR1qyBkcyaHehsSWM6PG1JjQ4DwWG6k1DYWPQLltYlgnfrMjui4vF1PGpy41u-x158OeAXd_78w69RnPEB_m8hvzcGz-RKHyAjsAsDQb7AN3uQRKzV8j77MQJXEHl99w1AuzKpNafYDM6gvRp2ObFn1WleEUqd7R_0M', role: 'Staff', isOnline: true },
    { id: 4, name: '山本 太郎', email: 't.yamamoto@gympro.jp', avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAXEOg_iYS6LRYZdmYsddpvMq1b1NLpiwiBqsWwnq6fjeMuXE3I65zj6J8vL1QveMdUvcox_fMUJpAK45iRJoWmlGEt4EMAy98rqLJNY6jcytcf9FnzNVMgrVbPYcEW4PRYa31ShXRUcNw8U9OUSK9z243YfaZeoLn3NmDBWU25J9LM5H659zpPHMF0gnRgvcoo1RiOpqh7VmorM2A-kuO_Zek0Sd4zJpqZ4wMmH949oAiukXk-07aAf1tv20p4iY0D8gpkh6cI8Hk', role: 'Staff', isOnline: true },
    { id: 5, name: '鈴木 花子', email: 'h.suzuki@gympro.jp', avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCOTmHNB0ZGcIs7hqgp3jVkx0h_A8bS9jIPtjq4JilvCwWCfrthpclirCPZIrj4PfMO3A2rNy-M1KCda_jq7iLPtk-xNVFKZqippajxl7L2xfxi8doWUcU-zk4aX93tYV02_QfZC2HwXPKswxrZ56baNNmN5NL-TZPATuQQbZb2gF4A5g8_V9T3K4MRarGpZjflvueHtTm9OMlGyV2Z1fOTeBP-g4SoHTzZhRhacx91Q-QBGpm1HJJapLAJvlTqaonOuMLfXzkByEI', role: 'Staff', isOnline: false }
];
...
// カテゴリーの情報
const categoryInfo = {
    blue: { name: 'Mat Pilates', color: 'bg-blue-600', textColor: 'text-blue-600', borderColor: 'border-blue-600' },
    red: { name: 'Weight Training', color: 'bg-red-600', textColor: 'text-red-600', borderColor: 'border-red-600' },
    green: { name: 'Sports Training', color: 'bg-emerald-600', textColor: 'text-emerald-600', borderColor: 'border-emerald-600' },
    yellow: { name: 'Movement Training', color: 'bg-amber-500', textColor: 'text-amber-500', borderColor: 'border-amber-500' }
};
...
function createTrainerCard(trainer: Trainer): string {
    ...
    const roleBadgeClass = trainer.role === 'Head'
...
function setupCategoryTabs(): void {
    document.querySelectorAll('.category-tab').forEach((tab) => {
        tab.addEventListener('click', (event) => {
            const target = event.target as HTMLElement;
            const category = target.closest('button')?.getAttribute('data-category') as 'blue' | 'red' | 'green' | 'yellow';
            if (category) {
...
function setupTrainerEventListeners(): void {
    ...
    if (addTrainerBtn) {
        addTrainerBtn.addEventListener('click', () => {
            ...
            const newTrainer: Trainer = {
                ...
                name: name,
                email: email,
                avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAXEOg_iYS6LRYZdmYsddpvMq1b1NLpiwiBqsWwnq6fjeMuXE3I65zj6J8vL1QveMdUvcox_fMUJpAK45iRJoWmlGEt4EMAy98rqLJNY6jcytcf9FnzNVMgrVbPYcEW4PRYa31ShXRUcNw8U9OUSK9z243YfaZeoLn3NmDBWU25J9LM5H659zpPHMF0gnRgvcoo1RiOpqh7VmorM2A-kuO_Zek0Sd4zJpqZ4wMmH949oAiukXk-07aAf1tv20p4iY0D8gpkh6cI8Hk',
                role: 'Staff',
                isOnline: false
            };
    ...
    document.querySelectorAll('.trainer-menu').forEach((button) => {
        button.addEventListener('click', (event) => {
            const target = event.target as HTMLElement;
            const trainerId = parseInt(target.closest('button')?.getAttribute('data-trainer-id') || '0');
